...
#Load in the data
dataset = shapeDataset(csvfile = 'shape_data.csv', rootdir = './output/',  
    transform = transforms.ToTensor())

train_set, test_set = torch.utils.data.random_split(dataset, [79999, 10000])
...
class Net(nn.Module):
    def __init__(self):
        ...
        # data has a single input channel, 54x54 images
        # create 6, 5x5 kernels
        # Pytorch does valid padding by default. 
        self.conv1 = nn.Conv2d(1, 6, 5)
        # output 6, 50x50 feature maps 
